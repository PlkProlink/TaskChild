...
public class ModelLog implements Serializable{
    ...
    private double porcentagemSuceso;
    /**
    ...
    /**
     * @return the porcentagemSuceso
     */
    public double getPorcentagemSuceso() {
        return (100.0)-(elementosRestantes*100.0)/(elementos+elementosRestantes);
    }

    /**
     * @param porcentagemSuceso the porcentagemSuceso to set
     */
    public void setPorcentagemSuceso(double porcentagemSuceso) {
        this.porcentagemSuceso = porcentagemSuceso;
    }
